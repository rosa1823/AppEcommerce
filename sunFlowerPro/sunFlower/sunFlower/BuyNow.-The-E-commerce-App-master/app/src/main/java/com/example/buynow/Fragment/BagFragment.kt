...
class BagFragment : Fragment(), CartItemClickAdapter {
    ...
    override fun onCreateView(
        ...
        boton = view.findViewById(R.id.checkOut_BagPage)
        boton!!.setOnClickListener { Toast.makeText(context,"Compra realizada exitosamente",Toast.LENGTH_SHORT).show()}
    ...
    override fun onItemDeleteClick(product: ProductEntity) {
        ...
        Toast.makeText(context,"Retirado de la bolsa",Toast.LENGTH_SHORT).show()
    }
